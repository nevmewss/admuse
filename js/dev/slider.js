...
function initSliders() {
  ...
  if (document.querySelector(".reviews-small__slider")) {
    new Swiper(".reviews-small__slider", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Navigation],
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".reviews-small-swiper-button-prev",
        nextEl: ".reviews-small-swiper-button-next"
      },
      // Брейкпоінти
      breakpoints: {
        320: {
  ...
  if (document.querySelector(".pages__slider ")) {
    new Swiper(".pages__slider", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Navigation],
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".pages-swiper-button-prev",
        nextEl: ".pages-swiper-button-next"
      },
      // Брейкпоінти
      breakpoints: {
        320: {
